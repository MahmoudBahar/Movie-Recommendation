...
@st.cache_resource
def load_data():
    return pd.read_pickle('../MoviesProcessed.pkl'), pd.read_pickle('../RatingsProcessed.pkl'), joblib.load('./Models/SVD.joblib'), joblib.load('./Models/SVDWeighted.joblib'), joblib.load('./Models/KNN.joblib'), pd.read_pickle('./Models/titleToIdx.pkl'), pd.read_pickle('./Models/idxToTitle.pkl')
